...
export const blogPosts: BlogPost[] = [
  {
    slug: "tyler-media-ssme-program-guide",
    date: "2026-06-01",
    author: "Tyler Media Team",
    category: { KR: "상생 & 마케팅", EN: "Support & Marketing" },
    title: {
      KR: "마케팅 예산 0원으로 타일러볼까요 PPL 주인공이 되는 법: SSME 프로그램 가이드",
      EN: "Redefining Market Access: The Tyler Media SSME Program"
    },
    excerpt: {
    ...
    body: {
      KR: [
        ...
        "이러한 문제를 해결하기 위해, 사업가 및 방송인 타일러 라쉬가 이끄는 타일러 미디어가 실질적인 해법을 제시합니다. 지난 6월 1일부터 공식 시작된 [타일러 미디어 SSME 프로그램]을 소개합니다.",
        ...
        "본 프로그램은 365일 상시 접수로 운영되며, 매 분기 첫 달(4월, 7월, 10월, 1월) 1일부터 15일 사이에 집중 심사를 거쳐 다음 분기에 콘텐츠가 본격 기획 및 송출됩니다. 단 5분이면 온라인으로 간편하게 접수가 가능하므로 타일러 미디어 공식 홈페이지 내 [SSME 프로그램] 탭을 통해 지금 바로 혁신의 기회를 잡으세요.",
        "또한, 오는 6월 9일부터 12일까지 진행되는 서울푸드 박람회 현장에서도 본 SSME 프로그램의 상세 비전과 파트너십 안내를 직접 대면으로 소개해 드릴 예정이오니 현장 방문객분들의 많은 관심 부탁드립니다."
      ],
      EN: [
        "The digital marketing landscape requires capital. For independent businesses and early-stage startups in South Korea, securing visibility often means competing against the vast advertising budgets of multinational corporations and established conglomerates. To address this imbalance, Tyler Media launched the SSME Program on June 1.",
        ...
        "To submit an application and access the official checklist, visit the [SSME Program] section at tylerrasch.com."
      ]
    },
    socialExcerpts: {
      ratio1x1: [
