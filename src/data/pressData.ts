...
export const pressReleases: PressRelease[] = [
  {
    slug: "tyler-media-ssme-program-launch",
    date: "2026-06-07",
    lang: "ko",
    title: "타일러 미디어, 소상공인·스타트업 성장을 위한 ‘SSME 프로그램’ 전격 가동",
    subtitle: "사업가 및 방송인 타일러 라쉬, 서울푸드 박람회서 상생 플랫폼 비전 제시 예고",
    byline: "이현지(Hyunji Lee) Lead (2026년 06월 07일, 서울)",
    intro5W1H: "이현지(Hyunji Lee) Lead (2026년 06월 07일, 서울) -- 타일러 미디어가 지난 1일부터 국내 소상공인과 스타트업의 자생력을 높이기 위한 ‘SSME 프로그램’을 본격 가동했다.",
    body: [
  ...
  {
    slug: "tyler-media-ssme-program-launch-en",
    date: "2026-06-07",
    lang: "en",
    title: "Tyler Media launches zero-cost product placement program for SMEs to counter corporate marketing concentration",
    body: [
      "SEOUL, South Korea — June 7, 2026 — Tyler Media initiated the SSME Program on June 1 to provide independent businesses with free product placement (PPL) on the digital media platform Tylerbolkkayo. The company will detail the initiative to industry stakeholders at the Seoul Food exhibition from June 9 to 12.",
...
export const epkBios: EPKBios = {
  short: "Tyler Rasch is a Global Macro/Geopolitical Intellectual, Author, Cross-Border Media Innovator, and Serial Entrepreneur based in Seoul. He holds a B.A. from the University of Chicago and an M.A. from Seoul National University, specializing in translating complex global intelligence into localized market capture for premium audiences.",
  medium: "Tyler Rasch is a prominent Global Macro/Geopolitical Intellectual, Author, Cross-Border Media Innovator, and Serial Entrepreneur. Armed with academic foundations from the University of Chicago (B.A. in International Studies) and Seoul National University (M.A. in International Relations / Political Science), Tyler has spent over a decade in South Korea translating complex global macroeconomic and technology security trends into localized market capture. As the founder of Tyler Media, he bridges international corporate ecosystems and premium audiences.",
  long: "Tyler Rasch is a Global Macro/Geopolitical Intellectual, Author, Cross-Border Media Innovator, and Serial Entrepreneur based in Seoul, South Korea. He received his Bachelor's degree in International Studies from the University of Chicago and his Master's degree in International Relations (Political Science) from Seoul National University. Over the past decade, Tyler has established himself as a prominent intellectual presence in South Korea's media landscape, translating complex global intelligence, macroeconomics, and technology security trends into localized market capture for premium audiences. As Chief Executive and Creative Director at Tyler Media (KNMIR Inc.), he leads cross-border enterprise initiatives, B2B strategic partnerships, and the SSME PR Program."
};

export const operationalMetrics: OperationalMetric[] = [
  { label: "YouTube Subscribers (Tylerbolkkayo)", value: "790K+", category: "reach" },
  { label: "Total YouTube Channel Views", value: "63M+", category: "reach" },
  { label: "SSME PR Program", value: "Ecosystem integration with partners like D.CAMP", category: "logistics" },
